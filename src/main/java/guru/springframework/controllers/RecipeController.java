...
public class RecipeController {
    ...
    public ModelAndView handleNumberFormat(Exception exception){ //to tell MVC the exception be passed in
        ...
        modelAndView.setViewName("400error"); //it's 400error.html page
